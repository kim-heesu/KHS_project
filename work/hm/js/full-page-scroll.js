...
(function () {
	...
	fullScroll.prototype.buildPublicFunctions = function () {
		...
		this.animateScroll = function () {
			...
			/*fade area*/
			var section1 = $('.dots li:nth-child(1) a');
			var section2 = $('.dots li:nth-child(2) a');
			var section3 = $('.dots li:nth-child(3) a');
			var section4 = $('.dots li:nth-child(4) a');

			if($(section1).hasClass("active")){
				$('.section1 .fade-area').addClass('active');
			}else{
				$('.section1 .fade-area').removeClass('active');
			}

			if($(section2).hasClass("active")){
				$('.section2 .fade-area').addClass('active');
			}else{
				$('.section2 .fade-area').removeClass('active');
			}

			if($(section3).hasClass("active")){
				$('.section3 .fade-area').addClass('active');
			}else{
				$('.section3 .fade-area').removeClass('active');
			}

			if($(section4).hasClass("active")){
				$('.section4 .fade-area').addClass('active');
			}else{
				$('.section4 .fade-area').removeClass('active');
			}
		};
